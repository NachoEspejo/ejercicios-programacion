...
public class Ejercicio35 {
  ...
  public static void main(String[] args) {
    ...
    System.out.print("Introduce la altura de la X (un número impar mayor o igual a 3): ");
    ...
    if ((alturaIntroducida < 3) || (alturaIntroducida % 2 == 0)) {
      System.out.print("Parece ser que tu comprensión lectora te falla, dice que insertes un número impar mayor o igual a 3...");
    } else {
      // parte de arriba 
